    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.articles.approve') }}"
                        class="text-indigo-600 text-sm hover:text-indigo-800">View all posts →</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.articles.approve') }}"
                        class="text-yellow-600 text-sm hover:text-yellow-800">Review pending →</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.users') }}" class="text-green-600 text-sm hover:text-green-800">Manage
                        users →</a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mt-4">
                    <a href="{{ route('admin.categories') }}" class="text-purple-600 text-sm hover:text-purple-800">View
                        categories →</a>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-1 gap-8 ">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($pendingArticles as $id => $article)
                                <tr>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-600">{{ $article->created_at->format('M d, Y') }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                    ...
                    <a href="{{ route('admin.users') }}" class="text-indigo-600 hover:text-indigo-800 text-sm">View
                        All</a>
                </div>
                <div class="overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Posts Count
                                </th>
